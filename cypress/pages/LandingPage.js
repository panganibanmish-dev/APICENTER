class LandingPage {
  elements = {
    ...
    textSubject: () =>
      cy.get(
        "section[class='text_center mb-6 wrap_min'] p[class='text_subject']"
      ),
    btnIntegrations: () =>
      cy.get("div[class='btn-box'] a[class='btn btn_secondary']"),
    ...
    text_sectionLeaders: () =>
      cy.get("section[class='text_center mb-6 wrap_min'] h2"),
    videobtn: () => cy.get(".video_button"),
    footer: () => cy.get(".color_theme.footer_title"),
    logoLievERP: () =>
      cy.get(
        "img[alt='logo'][src='/images/arno-de-liever-lieverp_logo_groot1.jpg']"
      ),
    logoEserviceWare: () =>
      cy.get(
        "img[alt='logo'][src='/images/eServiceware_payoff_uniek_met_visma_software_transparant-2.png']"
      ),
    logoMailBlue: () =>
      cy.get("img[alt='logo'][src='/images/ootb_mailblue_e-mail_logo4x.png']"),
    logoWeProcess: () => cy.get("img[alt='logo'][src='/images/Weprocess.png']"),
    labelTextDigitalTransformation: () =>
      cy.get("section[class='text_center mb-6'] h2"),
    pSingletext: () =>
      cy.get("section[class='text_center mb-6'] p[class='text_subject']"),
    titleApicenterSection: () =>
      cy.get("section[class='text_center mb-4 mt-2'] h2"),
    ...
    contact_becomePartnerAndQuestionNeedHelp: () =>
      cy.get(".contact_title.mt-1"),
  ...
  contactUs = () => {
    ...
    this.elements
      .contact_becomePartnerAndQuestionNeedHelp()
      .should("be.visible")
      .contains("Questions? Need help?");
    this.elements.link_here().should("be.visible").click();
    cy.visit("https://apicenter.io/partners/");
  };
  gotoCalenderPage = () => {
    cy.visit(
      "https://calendly.com/apicenter/partner-with-apicenter?month=2023-07"
    );
  };
  gotoLandingpage = () => {
  ...
  homepage = () => {
    this.elements
      .contentBox()
      .should("be.visible")
      .contains("Software direct, affordable, easy, integrations");
    this.elements
      .text()
      .should("be.visible")
      .contains(
        "API integrations designed to scale your application ecosystem and assure a fluid and secure flow of data."
      );
    ...
    this.elements
      .labelTextDigitalTransformation()
      .should("be.visible")
      .contains("The missing piece to a complete digital transformation");
    this.elements
      .pSingletext()
      .should("be.visible")
      .contains("From a single flow to complex flows with custom changes.");
    ...
    this.elements
      ...
      .eq(0)
      .should("be.visible")
      .contains("APIcenter suits all your integration needs");
    cy.contains("APicenter is equipped with features you'll love").should(
      "be.visible"
    );
    cy.contains("Why choose APIcenter as your iPaas system?").should(
      "be.visible"
    );
    this.elements
      .li_Section()
      .eq(0)
      .should("be.visible")
      .contains("Ease of use");
    this.elements
      .li_Section()
      .eq(1)
      .should("be.visible")
      .contains("Cost effective, no enterprise prices");
    this.elements
      .li_Section()
      .eq(2)
      .should("be.visible")
      .contains("Overview of transactions");
    this.elements
      .li_Section()
      .eq(3)
      .should("be.visible")
      .contains("Warning center; instant error notifications");
    this.elements
      .li_Section()
      .eq(4)
      .should("be.visible")
      .contains("Team with years of API knowledge");
    cy.contains("Integrate anything and everything!").should("be.visible");
    this.elements
      .div_text()
      .should("be.visible")
      .contains(
        "Extend your business integrations across your ecosystem. With APIcenter you can integrate webshops, "
      );
  ...
  navPlatform = () => {
    ...
    cy.contains("What Can You Do with the APIcenter Platform?").should(
      "be.visible"
    );
    cy.contains("a", "Platform").should("be.visible").realHover("mouse");
  ...
  navPartners = () => {
    ...
    cy.get(".btn.btn_secondary")
      .should("be.visible")
      .contains("become an integration partner")
      .click();
    this.gotoLandingpage();
  };
