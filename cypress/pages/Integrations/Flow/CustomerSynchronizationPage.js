class CustomerSynchronizationPage {
  elements = {
    ...
    customerFlow: () =>
      cy.get(
        "body > div:nth-child(2) > main:nth-child(3) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3)"
      ),
    //stg
    stg_customerFlow: () =>
      cy.get(
        "body > div:nth-child(1) > main:nth-child(3) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3)"
      ),
    //dev
    dev_customerFlow: () =>
      cy.get(
    ...
    overviewTab: () =>
      cy.get(
        "body > div:nth-child(2) > main:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a:nth-child(1)"
      ),
  ...
  acitvitySettingsTab = () => {
    ...
    this.elements
      .selectFlow()
      .select("getCustomer")
      .should("have.value", "getCustomer");
    this.elements
      .selectFlow()
      .select("sendCustomer")
      .should("have.value", "sendCustomer");
  ...
  customerSynchronizationFlow = () => {
    ...
    this.elements.resumeFlowbtn().should("be.visible").click();
    cy.intercept("**/flag-update").as("okResumeFlow");
    this.elements.okbtn().click();
    cy.wait("@okResumeFlow");
    this.elements.okbtn().click();
    //setting tab
