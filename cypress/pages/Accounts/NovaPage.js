class NovaPage {
  elements = {
    ...
    sideBarInvoices: () =>
      cy.get(
        ".text-white.text-justify.no-underline.dim[href='/nova/resources/invoices']"
      ),
    sideBarOrders: () =>
      cy.get(
        ".text-white.text-justify.no-underline.dim[href='/nova/resources/orders']"
      ),
    sideBarSubscriptions: () =>
      cy.get(
        ".text-white.text-justify.no-underline.dim[href='/nova/resources/subscriptions']"
      ),
    search: () => cy.get("input[placeholder='Search']"),
    ID: () => cy.get(".text-left.text-left"),
    clickEyesIcon: () =>
      cy.get(
        "tbody tr:nth-child(1) td:nth-child(8) div:nth-child(1) span:nth-child(2)"
      ),
    ...
    modalBtnCancel: () =>
      cy.get(".btn.btn-link.dim.cursor-pointer.text-80.ml-auto.mr-6"),
    clickRecipient: () =>
      cy.get(
        "body > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div:nth-child(4) > div:nth-child(2) > div:nth-child(1) > table:nth-child(1) > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1) > a:nth-child(1)"
      ),
    ...
    btnNext: () =>
      cy.get(".btn.btn-link.py-3.px-4.text-primary.dim[rel='next']"),
    btnPrev: () =>
      cy.get(".btn.btn-link.py-3.px-4.text-primary.dim[rel='prev']"),
    ordersIndex: () => cy.get("div[dusk='orders-index-component']"),
    subscriptionsIndex: () =>
      cy.get("div[dusk='subscriptions-index-component']"),
    sideBarUsers: () =>
      cy.get(
  ...
  recipientDetails = () => {
    ...
    this.elements
      .recipient()
      .scrollIntoView({ duration: 100000 })
      .should("be.visible");
