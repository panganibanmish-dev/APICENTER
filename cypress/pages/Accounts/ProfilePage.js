class ProfilePage {
  elements = {
    ...
    dropdownProfileLanguage: () =>
      cy.get("div[class='form-group'] div[class='multiselect__select']"),
    ...
    drpdwnCountry: () =>
      cy.get("div[class='form_group'] div div[class='multiselect__tags']"),
  ...
  updateContactInformation = (
    ...
    this.elements
      .msgSuccess()
      .should("be.visible")
      .contains("Your contact information has been updated!");
  };
  //Update info and showing confirmation updated
  ...
  invalidBillingAddressInfo = () => {
    ...
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The billing address field is required.");
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The billing city field is required.");
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The billing zip field is required.");
  };
}
