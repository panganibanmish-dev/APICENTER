class SignupPage {
  elements = {
    ...
    drpdownApps: () =>
      cy.get("div[type='multi-select'] div[class='multiselect__tags']"),
  ...
  clickToggleTermsAndProcessingAgreement() {
    this.elements
      ...
      .check({ force: true });
    this.elements
      .clickToggleProcessingAgreement()
      .should("be.not.visible")
      .check({ force: true });
  }
  ...
  fillData = (newUser) => {
    ...
    this.elements
      ...
      .should("be.visible")
      .clear()
      .type(inputInfoUser.firstname);
    this.elements
      .inputLastName()
      .should("be.visible")
      .clear()
      .type(inputInfoUser.lastname);
    this.elements
      .inputPhoneNumber()
      .should("be.visible")
      .clear()
      .type(inputInfoUser.phonenumber);
    this.elements
      .inputEmailAdd()
      .should("be.visible")
      .clear()
      .type(`user_test${Date.now()}@mailinator.com`); //generate email for new user
    this.elements
      .inputPassword()
      .should("be.visible")
      .clear()
      .type(inputInfoUser.password);
    this.elements
      .inputConfirmPassword()
      .should("be.visible")
      .clear()
      .type(inputInfoUser.confirmpassword);
  };
  ...
  checkRequireFields() {
    ...
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The Last name field is required.");
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The E-mail field is required.");
    this.elements
      .errormsg()
      .should("be.visible")
    ...
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The Applications field is required.");
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The Terms of Service must be accepted.");
    this.elements
      .errormsg()
      .should("be.visible")
      .contains("The Processing agreement must be accepted.");
  }
